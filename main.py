...
#Making front end
st.title("CRYPTOCURRENCY AND ITS FUTURE")
#st.header("This is Cryptocurrency Price Prediction Webiste")
image = Image.open('cryptocurrency-market.jpg')
st.image(image, caption='Cryptocurrency')


st.write('Welcome to the Cryptocurrency price prediction app,s here you will get information about cryptocurrency like bitcoin, ethereum and litheum.')
...
image = Image.open('bitcoin2.jpg')
st.sidebar.image(image)

result = st.sidebar.button("BITCOIN")
st.write(result)

image = Image.open('ethereum.png')
st.sidebar.image(image)
result2 = st.sidebar.button("Ethereum")
st.write(result2)
st.sidebar.write('After Selecting Please Scroll Down Page')


#Bitcoin prediction
if result:
    #price pridiction for BITCOIN
    #IMPORTING DATA FILE
    ...
    image = Image.open('bitcoin.jpg.png')
    st.image(image)
